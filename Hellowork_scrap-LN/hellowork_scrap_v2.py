...
def get_request(url) -> str:
    ...
    # - return None in case of error (which is the case with loggings anyway)
...
if __name__ == "__main__":
    print(hellowork_scrap("https://www.hellowork.com/fr-fr/emplois/32898119.html", "544545454"))
